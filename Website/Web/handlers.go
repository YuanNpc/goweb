...
// CreateUser
// w http.ResponseWriter：表示一个用于向客户端发送响应的 http.ResponseWriter 对象。
// r *http.Request：表示客户端发来的 HTTP 请求的 http.Request 对象指针，包含了请求的各种信息。
// p httprouter.Params：表示路由中的参数，可以从中获取路由中的变量参数。
